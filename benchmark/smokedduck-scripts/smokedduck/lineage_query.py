...
def _generate_lineage_query(
    ...
    op = operator_factory.get_op(plan_node['name'], plan_node['opid'], query_id, parent_join_cond, plan_node, parent_join_type)
    ...
    if op.get_name() == "UNGROUPED_AGGREGATE":
        agg_child_op = operator_factory.get_op(children[0]['name'], plan_node['opid'], query_id, parent_join_cond, children[0], parent_join_type)
