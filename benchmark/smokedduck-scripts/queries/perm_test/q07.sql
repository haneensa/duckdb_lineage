  select Qbase.out_index-1 as out_index, supplier, lineitem, orders, customer, nation,  nation_1
  from (
    SELECT supplier.rowid as supplier, lineitem.rowid as lineitem, orders.rowid as orders,
        customer.rowid as customer, n1.rowid as nation_1, n2.rowid  as nation,
