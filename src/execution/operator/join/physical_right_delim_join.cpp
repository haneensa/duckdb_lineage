...
#ifdef LINEAGE
	lineage_manager->Set((void *)(join.get()), (void*)&context.thread);
#endif
...
#ifdef LINEAGE
	lineage_manager->Set((void *)(distinct.get()), (void*)&context.thread);
#endif
...
#ifdef LINEAGE
	lineage_manager->Set((void *)(join.get()), (void*)&client);
#endif
...
#ifdef LINEAGE
	lineage_manager->Set((void *)(distinct.get()), (void*)&client);
#endif
